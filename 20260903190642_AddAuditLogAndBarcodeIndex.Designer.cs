...
namespace POSSystem.Migrations
{
    ...
    [Migration("20260903190642_AddAuditLogAndBarcodeIndex")]
    partial class AddAuditLogAndBarcodeIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("POSSystem.Models.Expense", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("POSSystem.Models.ExpenseCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("POSSystem.Models.Purchase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("POSSystem.Models.PurchaseItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("POSSystem.Models.SaleReturn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("POSSystem.Models.SaleReturnItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("POSSystem.Models.Expense", b =>
                {
                    b.HasOne("POSSystem.Models.ExpenseCategory", "ExpenseCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("POSSystem.Models.PurchaseItem", b =>
                {
                    ...
                    b.HasOne("POSSystem.Models.Purchase", "Purchase")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("POSSystem.Models.SaleReturnItem", b =>
                {
                    ...
                    b.HasOne("POSSystem.Models.SaleReturn", "SaleReturn")
                        .WithMany("Items")
